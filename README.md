# DevOps Project - Hybrid Continuous Delivery of Vprofile Project (Jenkins&AWS)
...
AWS_S3_BUCKET = 'vprocicdbean-stalk'
...
Now you should have the artifact and Beanstalk App version in the S3 bucket.
...
Let`s delete the resources we have created.